...
public class Screen extends FocusableGui implements IScreen, IRenderable
{
    ...
    public Screen(ITextComponent titleIn)
    {
        this.title = titleIn;
    }
    ...
    private final ResourceLocation backmenu = new ResourceLocation("render/images/mainmenu/backmenu.png");
    public void renderDirtBackground(int vOffset)
    {
        ...
        if (SelfDestruct.unhooked || Minecraft.getInstance().currentScreen instanceof PackScreen) {
            ...
            if (Minecraft.getInstance().player == null) GraphicsSystem.drawImage(backmenu, 0, 0, width, height, -1);;
        }
    }
