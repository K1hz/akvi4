...
public class ResourceLoadProgressGui extends LoadingGui
{
    ...
    private static final ResourceLocation MOJANG_LOGO_TEXTURE_AG = new ResourceLocation("render/images/minecraft/agstudios.png");
    private static final int field_238627_b_ = ColorHelper.PackedColor.packColor(255, 239, 50, 61); // Красный
    private static int field_238628_c_ = 0xFF000000;
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (SelfDestruct.unhooked) {
            colorBackground = field_238627_b_ & 16777215;
            colorBar = field_238627_b_ & 16777215;
        }
        if (!SelfDestruct.unhooked) {
    ...
    private void func_238629_a_(MatrixStack p_238629_1_, int p_238629_2_, int p_238629_3_, int p_238629_4_, int p_238629_5_, float p_238629_6_)
    {
        if (SelfDestruct.unhooked) {
            ...
            if (this.colorBar != this.colorBackground)
            {
                ...
                fill(p_238629_1_, p_238629_2_, p_238629_3_ + 15, p_238629_4_, p_238629_5_, j1);
            }
            ...
            fill(p_238629_1_, p_238629_2_ + 1, p_238629_3_ + 15, p_238629_4_ - 1, p_238629_3_ + 15 + 1, i3);
            fill(p_238629_1_, p_238629_2_ + 1, p_238629_5_, p_238629_4_ - 1, p_238629_5_ - 1, i3);
            fill(p_238629_1_, p_238629_2_, p_238629_3_ + 15, p_238629_2_ + 1, p_238629_5_, i3);
            fill(p_238629_1_, p_238629_4_, p_238629_3_ + 15, p_238629_4_ - 1, p_238629_5_, i3);
            int k1 = this.colorProgress >> 16 & 255;
            int l1 = this.colorProgress >> 8 & 255;
            int i2 = this.colorProgress & 255;
            int textX = p_238629_2_ + (p_238629_4_ - p_238629_2_) / 2;
            int textY = p_238629_3_ + 15 + (p_238629_5_ - p_238629_3_ + 15) / 2;

            p_238629_1_.push();
            p_238629_1_.translate(textX, textY + 15, 0);
            p_238629_1_.scale(2.0F, 2.0F, 1.0F); // Увеличение текста в 2 раза
            ...
            fill(p_238629_1_, p_238629_2_ + 2, p_238629_3_ + 15 + 2, p_238629_2_ + i, p_238629_5_ - 2, i3);
        }
        if (!SelfDestruct.unhooked) {
            int i = MathHelper.ceil((float)(p_238629_4_ - p_238629_2_ - 2) * this.progress);
            int j = Math.round(p_238629_6_ * 255.0F);
            ...
            int textX = p_238629_2_ + (p_238629_4_ - p_238629_2_) / 2;
            int textY = p_238629_3_ + 15 + (p_238629_5_ - p_238629_3_ + 15) / 2;
            String progressText = (int) (this.progress * 100) + "%";
