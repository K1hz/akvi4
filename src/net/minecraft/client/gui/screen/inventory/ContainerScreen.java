...
import minecraft.game.operation.misc.InventoryPlus;
...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        RenderSystem.DDDSLBescaleNormal();
...
//                    /* Самый дешёвый*/
//                    fill(matrixStack, x, y, x + 16, y + 16, ColoringSystem.rgba(64, 255, 64, (int)3.75f));
//                    /* Второй по цене*/
//                    if (helper.getX2() != 0) {
//                        int x2 = (int) helper.getX2();
//                        int y2 = (int) helper.getY2();
//                        fill(matrixStack, x2, y2, x2 + 16, y2 + 16, ColoringSystem.rgba(255, 255, 64, (int) 3.75f));
//                    }
//                    /* и ластовый красный */
//                    if (helper.getX3() != 0) {
//                        int x3 = (int) helper.getX3();
//                        int y3 = (int) helper.getY3();
//                        fill(matrixStack, x3, y3, x3 + 16, y3 + 16, ColoringSystem.rgba(255, 64, 64, (int) 3.75f));
//                    }
//                }
//            }
