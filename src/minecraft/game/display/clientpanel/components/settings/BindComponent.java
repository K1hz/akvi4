...
public class BindComponent extends Component {
    ...
    public void render(MatrixStack matrixStack, float mouseX, float mouseY) {
        ...
        if (fitsInSingleLine) {
            GraphicsSystem.drawRoundedRect(endX, y + 3, bindWidth, 11, radius, ColoringSystem.rgba(16,16,16, 35));
            ...
            GraphicsSystem.drawRoundedRect(x + 8, bindY, bindWidth, 11, radius, ColoringSystem.rgba(16,16,16, 35));
