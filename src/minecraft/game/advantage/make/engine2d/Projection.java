...
public class Projection implements IMinecraft {
    ...
    public static Vector3d interpolate(Entity entity, float partialTicks) {
        double posX = MathSystem.lerp(entity.lastTickPosX, entity.getPosX(), partialTicks);
        double posY = MathSystem.lerp(entity.lastTickPosY, entity.getPosY(), partialTicks);
        double posZ = MathSystem.lerp(entity.lastTickPosZ, entity.getPosZ(), partialTicks);
