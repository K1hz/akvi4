...
import minecraft.system.via.VersionSelectScreen;
...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = AG.getInst().getVarMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(AG.getInst().getVarMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        AG.getInst().getVarMCP().viaScreen.tick();
