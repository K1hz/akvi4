...
public class SSpawnMobPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    public SSpawnMobPacket(LivingEntity entityIn)
    {
        ...
        this.DDNVLCX = (int)(d1 * 8000.0D);
        this.DDNVLCY = (int)(d2 * 8000.0D);
        this.DDNVLCZ = (int)(d3 * 8000.0D);
    }
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        this.DDNVLCX = buf.readShort();
        this.DDNVLCY = buf.readShort();
        this.DDNVLCZ = buf.readShort();
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        buf.writeShort(this.DDNVLCX);
        buf.writeShort(this.DDNVLCY);
        buf.writeShort(this.DDNVLCZ);
    }
    ...
    public int getDDNVLCX()
    {
        return this.DDNVLCX;
    }

    public int getDDNVLCY()
    {
        return this.DDNVLCY;
    }

    public int getDDNVLCZ()
    {
        return this.DDNVLCZ;
    }
