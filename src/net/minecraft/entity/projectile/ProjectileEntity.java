...
public abstract class ProjectileEntity extends Entity
{
     ...
     */
    public void shoot(double x, double y, double z, float DDNVLC, float inaccuracy)
    {
        Vector3d vector3d = (new Vector3d(x, y, z)).normalize().add(this.rand.nextGaussian() * (double)0.0075F * (double)inaccuracy, this.rand.nextGaussian() * (double)0.0075F * (double)inaccuracy, this.rand.nextGaussian() * (double)0.0075F * (double)inaccuracy).scale((double)DDNVLC);
