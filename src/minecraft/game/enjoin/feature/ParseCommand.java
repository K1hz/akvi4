...
public class ParseCommand implements Command, IMinecraft {
    ...
    public String description() {
        return "Парсит игроков из таба. (В папку 'System/Folder/Parsed')";
    }
    ...
    private void savePlayerData() {
        ...
        File directory = new File("System/Folder/Parsed");
        if (!directory.exists()) {
            directory.mkdirs();
        }
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            ...
            String relativePath = "System/Folder/Parsed/" + fileName + ".txt";
