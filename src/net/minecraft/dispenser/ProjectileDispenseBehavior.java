...
public abstract class ProjectileDispenseBehavior extends DefaultDispenseItemBehavior
{
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
    {
        ...
        projectileentity.shoot((double)direction.getXOffset(), (double)((float)direction.getYOffset() + 0.1F), (double)direction.getZOffset(), this.getProjectileDDNVLC(), this.getProjectileInaccuracy());
    ...
    protected float getProjectileDDNVLC()
    {
        return 1.1F;
    }
}
