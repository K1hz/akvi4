...
public class ModeComponent extends Component {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        ClientFonts.clickGui[16].drawCenteredString(stack, option.getName(), optionRectX + 58, y + yOffset + 5, -1);
        ...
        if (opened || !heightAnimation.isDone()) {
            ...
            for (String s : option.strings) {
                ...
                int textColor = option.getValue().equals(s) ? Hud.getColor(1) : 0xFFA3B0BC;
                ...
                ClientFonts.clickGui[14].drawCenteredString(stack, s, textX + 53, itemY + 7, ColoringSystem.setAlpha(textColor, textAlpha));
                i++;
            }
        }
    }
