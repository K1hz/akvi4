...
public class ESPShader implements IMinecraft {
    private final ShaderModules upSample = new ShaderModules("kawaseUpBloom");
    private final ShaderModules downSample = new ShaderModules("kawaseDownBloom");
    ...
    private void initFramebuffers(float iterations) {
        ...
        framebufferList.add(outFramebuffer = GraphicsSystem.FrameBuffer.createFrameBuffer(null, false));
    ...
    public void draw(int iterations, float offset, RenderType type, float saturation) {
        ...
        if (framebufferSizeChanged) {
            ...
            inFramebuffer = GraphicsSystem.FrameBuffer.createFrameBuffer(inFramebuffer);
        }
        ...
        switch (type) {
            ...
            case DISPLAY -> {
                ...
                OpenGLSystem.startBlend();
                drawQuads();
                OpenGLSystem.endBlend();
    ...
    private void renderFBO(Framebuffer framebuffer, int framebufferTexture, ShaderModules shader, float offset) {
