...
@UtilityClass
public class MathSystem implements IMinecraft {
    ...
    public static double randomWithUpdate(double min, double max, long ms, TimeCounterSetting TimeCounterSetting) {
        double randomValue = 0;

        if (TimeCounterSetting.isReached(ms)) {
