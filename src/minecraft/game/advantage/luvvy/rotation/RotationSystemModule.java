...
import minecraft.game.advantage.figures.VectorHZSystem;
...
public class RotationSystemModule implements IMinecraft {

    public RotationSystemModule() {
    ...
    public Vector3d getClosestVec(Entity entity) {
        ...
        return VectorHZSystem.getClosestVec(eyePosVec, entity).subtract(eyePosVec);
    }
