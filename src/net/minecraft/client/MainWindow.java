...
public final class MainWindow implements AutoCloseable {
    ...
    public void setGuiScale(double scaleFactor) {
        ...
        this.scaledWidth = (double) this.framebufferWidth / 2f > (double) i ? i + 1 : i;
        int j = (int) ((double) this.framebufferHeight / 2f);
        this.scaledHeight = (double) this.framebufferHeight / 2f > (double) j ? j + 1 : j;
    }
