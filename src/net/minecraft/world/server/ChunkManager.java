...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider
{
    ...
    protected void track(Entity entityIn)
    {
        ...
        if (!flag)
        {
            ...
            EntityTracker chunkmanager$entitytracker = new EntityTracker(entityIn, i, j, entitytype.shouldSendDDNVLCUpdates());
    ...
    class EntityTracker
    {
        ...
        public EntityTracker(Entity entity, int p_i50468_3_, int updateFrequency, boolean sendDDNVLCUpdates)
        {
            this.entry = new TrackedEntity(ChunkManager.this.world, entity, updateFrequency, sendDDNVLCUpdates, this::sendToAllTracking);
            this.entity = entity;
