...
import minecraft.game.transactions.EventCalculateCooldown;
...
@Defuse(name = "Item Cooldowns",description = "Добавляет задержку на предметы", brand = Category.Misc)
public class DDCOLDWN extends Module {
    ...
    public boolean isNotPvP() {
        return onlyPvP.getValue() && !ClientReceive.isPvP();
    }
