    ...
    protected List<String> getInfoLeft() {
        ...
        if (this.mc.isReducedDebug()) {
            if (SelfDestruct.unhooked) {
                ...
                return Lists.newArrayList("Minecraft " + SharedConstants.getVersion().getName() + " (" + "OptiFine_1.16.5_HD_U_G8" + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, s, this.mc.worldRenderer.getDebugInfoRenders(), this.mc.worldRenderer.getDebugInfoEntities(), "P: " + this.mc.particles.getStatistics() + ". T: " + this.mc.world.getCountLoadedEntities(), this.mc.world.getProviderName(), "", String.format("Chunk-relative: %d %d %d", blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15));
            }
        } else {
            Entity entity = this.mc.getRenderViewEntity();
            ...
            List<String> list;
            String versionInfo = "Minecraft " + SharedConstants.getVersion().getName() + " ("
                    + this.mc.getVersion() + "/"
            ...
            if (SelfDestruct.unhooked) {
                list = Lists.newArrayList(versionInfo,
                        this.mc.debug,
                        s,
                ...
                String optifineVersionInfo = "Minecraft " + SharedConstants.getVersion().getName() + " (OptiFine_1.16.5_HD_U_G8/"
                        + ClientBrandRetriever.getClientModName()
                        + ("release".equalsIgnoreCase(this.mc.getVersionType()) ? "" : "/" + this.mc.getVersionType())
                        + ")";
                list = Lists.newArrayList(optifineVersionInfo,
                        this.mc.debug,
                        s,
                        this.mc.worldRenderer.getDebugInfoRenders(),
                        this.mc.worldRenderer.getDebugInfoEntities(),
