...
public class Shaders
{
    ...
    public static int DDNVLCAttrib = baseAttribId + 3;
    ...
    public static boolean useDDNVLCAttrib = false;
    ...
    public static boolean progUseDDNVLCAttrib = false;
    ...
    private static void setupProgram(Program program, String vShaderPath, String gShaderPath, String fShaderPath)
    {
        ...
        if (i != 0 || j != 0 || k != 0)
        {
            ...
            if (progUseDDNVLCAttrib)
            {
                ARBVertexShader.glBindAttribLocationARB(l, DDNVLCAttrib, "at_DDNVLC");
                checkGLError("at_DDNVLC");
            }
                        ...
                        for (String s : linebuffer1)
                        {
                            ...
                            if (macrostate.processLine(s))
                            {
                                ...
                                if (shaderline != null)
                                {
                                    ...
                                    else if (shaderline.isAttribute("at_DDNVLC"))
                                    {
                                        useDDNVLCAttrib = true;
                                        progUseDDNVLCAttrib = true;
                                    }
