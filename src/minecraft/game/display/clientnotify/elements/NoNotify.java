...
public class NoNotify extends Notify {
    ...
    public void render(MatrixStack matrixStack, int multiplierY) {
        ...
        ClientFonts.icons_wex[iconSizeF].drawString(matrixStack, "I", posX - (iconSize - 3) + animPos, posY - height / 2 + ClientFonts.icons_wex[iconSizeF].getFontHeight() - margin / 2 + 0.5f, ColoringSystem.reAlphaInt(-1, (int) (255 * alphaValue)));
