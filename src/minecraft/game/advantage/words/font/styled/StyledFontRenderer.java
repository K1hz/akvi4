package minecraft.game.advantage.words.font.styled;
...
import minecraft.game.advantage.words.font.Wrapper;
...
public final class StyledFontRenderer implements Wrapper {
    ...
    public static float drawCenteredXString123(MatrixStack matrices, StyledFont font, String text, double x, double y, int color) {
        ...
        for (ITextComponent textComponent : text.getSiblings()) {
            ...
            for (ITextComponent textComponent1 : textComponent.getSiblings()) {
                ...
                if (textComponent1.getStyle().getColor() != null) {
                    rgb = ColoringSystem.rgba(textComponent1.getStyle().getColor().getColor());
                    r1 = rgb[0];
                    r2 = rgb[1];
                    r3 = rgb[2];
                    r4 = 1;
