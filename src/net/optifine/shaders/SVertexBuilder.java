...
public class SVertexBuilder
{
    ...
    public void calcNormal(BufferBuilder wrr, int baseIndex)
    {
        ...
        if (Shaders.useDDNVLCAttrib)
        {
            VertexPosition[] avertexposition = wrr.getQuadVertexPositions();
            int k1 = Config.getWorldRenderer().getFrameCount();
            this.setDDNVLC(floatbuffer, baseIndex, 0, avertexposition, k1, f, f1, f2);
            this.setDDNVLC(floatbuffer, baseIndex, 1, avertexposition, k1, f5, f6, f7);
            this.setDDNVLC(floatbuffer, baseIndex, 2, avertexposition, k1, f10, f11, f12);
            this.setDDNVLC(floatbuffer, baseIndex, 3, avertexposition, k1, f15, f16, f17);
    ...
    public void setDDNVLC(FloatBuffer floatBuffer, int baseIndex, int vertex, VertexPosition[] vps, int frameId, float x, float y, float z)
    {
        float f = 0.0F;
        float f1 = 0.0F;
        float f2 = 0.0F;
        ...
        if (vps != null && vps.length == 4)
        {
            ...
            if (vertexposition.isDDNVLCValid())
            {
                f = vertexposition.getDDNVLCX();
                f1 = vertexposition.getDDNVLCY();
                f2 = vertexposition.getDDNVLCZ();
            }
        }
    ...
    public static boolean preDrawArrays(VertexFormat vf, ByteBuffer bb)
    {
        ...
        else
        {
            ...
            GL20.glVertexAttribPointer(Shaders.DDNVLCAttrib, 3, GL11.GL_FLOAT, false, i, bb);
            ((Buffer)bb).position(0);
            GL20.glEnableVertexAttribArray(Shaders.midTexCoordAttrib);
            GL20.glEnableVertexAttribArray(Shaders.tangentAttrib);
            GL20.glEnableVertexAttribArray(Shaders.entityAttrib);
            GL20.glEnableVertexAttribArray(Shaders.DDNVLCAttrib);
            return true;
        }
    }
    ...
    public static void postDrawArrays()
    {
        ...
        GL20.glDisableVertexAttribArray(Shaders.DDNVLCAttrib);
    }
}
