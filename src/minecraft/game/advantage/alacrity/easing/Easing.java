...
public enum Easing {
    ...
    EASE_IN_BACKWILL(x -> x < 0.5 ? (Math.pow(2 * x, 2) * (((1.70158 * 1.525) + 1) * 2 * x - (1.70158 * 1.525))) / 2 : (Math.pow(2 * x - 2, 2) * (((1.70158 * 1.525) + 1) * (x * 2 - 2) + (1.70158 * 1.525)) + 2) / 2),
    ...
    EASE_IN_ELASTIC(x -> x == 0 ? 0 : x == 1 ? 1 : -Math.pow(2, 10 * x - 10) * sin((x * 10 - 10.75) * ((2 * Math.PI) / 3))),
    EASE_OUT_ELASTIC(x -> x == 0 ? 0 : x == 1 ? 1 : Math.pow(2, -10 * x) * sin((x * 10 - 0.75) * ((2 * Math.PI) / 3)) * 0.5 + 1),
    EASE_IN_OUT_ELASTIC(x -> x == 0 ? 0 : x == 1 ? 1 : x < 0.5 ? -(Math.pow(2, 20 * x - 10) * sin((20 * x - 11.125) * ((2 * Math.PI) / 4.5))) / 2 : (Math.pow(2, -20 * x + 10) * sin((20 * x - 11.125) * ((2 * Math.PI) / 4.5))) / 2 + 1),

    // Новый easing для изменения только прозрачности
    EASE_OUT_ALPHA(x -> x * (2 - x)); // Применяется только к альфа-каналу
