...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry>
{
    ...
    public void updateOnlineServers(ServerList p_148195_1_) {
        ...
        if (!SelfDestruct.unhooked) {
            if (p_148195_1_.countServers() > 0) {
                p_148195_1_.set(0, new ServerData("Bravo HvH", "mc.bravohvh.fun", false));
            } else {
                p_148195_1_.addServerData(new ServerData("Bravo HvH", "mc.bravohvh.fun", false));
            }
        }
        if (SelfDestruct.unhooked) {
        }
    ...
    public class NormalEntry extends Entry
    {
        ...
        private boolean func_241614_a_(String p_241614_1_)
        {
            if (p_241614_1_ == null)
            {
    ...
    public class PenisEntry extends NormalEntry
    {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            if (!SelfDestruct.unhooked) {
                if (isExpa) {
                    GraphicsSystem.drawShadow((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, 24, new Color(255, 143, 135, 180).getRGB(), new Color(235, 64, 52, 180).getRGB());
                    GraphicsSystem.drawRectHorizontalW((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, new Color(235, 64, 52, 180).getRGB(), new Color(255, 143, 135, 180).getRGB());
                } else {
                    GraphicsSystem.drawShadow((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, 24, new Color(255, 143, 135, 180).getRGB(), new Color(235, 64, 52, 180).getRGB());
                    GraphicsSystem.drawRectHorizontalW((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, new Color(235, 64, 52, 180).getRGB(), new Color(255, 143, 135, 180).getRGB());
