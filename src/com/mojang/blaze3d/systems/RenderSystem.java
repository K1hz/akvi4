...
import static minecraft.game.advantage.advisee.IMinecraft.*;
import static minecraft.game.advantage.make.engine2d.GraphicsSystem.quads;
...
public class RenderSystem
{
    ...
    public static void drawImage1(MatrixStack stack, ResourceLocation resourceLocation, double v, double v1, double v2, float x, float y, float width, float height,
                                  int color, int i) {
        RenderSystem.pushMatrix();
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
    ...
    @Deprecated
    public static void DDDSLBescaleNormal()
    {
        assertThread(RenderSystem::isOnGameThread);
        GlStateManager.DDDSLBescaleNormal();
    }
