...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        ...
        DDBETTER betterMinecraft = functionRegistry.getDDBETTER();
        ...
        for (int i5 = 0; i5 < i4; ++i5) {
            ...
            if (i5 < list.size()) {
                ...
                if (isBetter) {
                    ...
                    int color = ColoringSystem.red;

                    if (ping < 150) {
                        color = ColoringSystem.green;
                    } else if (ping < 300) {
                        color = ColoringSystem.yellow;
                    } else if (ping < 600) {
                        color = ColoringSystem.orange;
                    }
        ...
        if (objective.getRenderType() == ScoreCriteria.RenderType.HEARTS) {
            ...
            if (this.lastTimeOpened == info.getRenderVisibilityId()) {
                if (i < info.getLastHealth()) {
                    ...
                    info.setHealthDDBLICKTime((long) (this.guiIngame.getTicks() + 20));
                } else if (i > info.getLastHealth()) {
                    info.setLastHealthTime(j);
                    info.setHealthDDBLICKTime((long) (this.guiIngame.getTicks() + 10));
                }
            }
            ...
            boolean flag = info.getHealthDDBLICKTime() > (long) this.guiIngame.getTicks() && (info.getHealthDDBLICKTime() - (long) this.guiIngame.getTicks()) / 3L % 2L == 1L;
