...
public class ConfigManager {
    ...
    public final File CONFIG_DIR = new File(Minecraft.getInstance().gameDir, "\\System\\Folder\\Configurations\\");
    public final File AUTOCFG_DIR = new File(CONFIG_DIR, "backup.ag");
    ...
    public List<Config> getConfigs() {
        ...
        if (configFiles != null) {
            for (File configFile : configFiles) {
                if (configFile.isFile() && configFile.getName().endsWith(".ag")) {
                    String configName = configFile.getName().replace(".ag", "");
    ...
    public Config findConfig(String configName) {
        ...
        if (new File(CONFIG_DIR, configName + ".ag").exists())
