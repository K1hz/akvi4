...
import minecraft.system.capes.CapeHolder;
import minecraft.system.capes.sim.StickSimulation;
...
import minecraft.game.advantage.make.other.GifModuleSystemRender;
...
public abstract class AbstractClientPlayerEntity extends PlayerEntity implements CapeHolder
{
    ...
    public ResourceLocation getLocationSkin() {
        WorldTweaks worldTweaks = AG.getInst().getModuleManager().getWorldTweaks();
        NetworkPlayerInfo networkplayerinfo = this.getPlayerInfo();
    ...
    private final ResourceLocation CAPE_LOCATION = new ResourceLocation("render/images/gif/cape/cape.png");
    ...
    public boolean hasCustomCape() {
        return this instanceof ClientPlayerEntity
                || AG.getInst().getFriendManager().isFriend(this.getNameClear());
    }
    /**
